  ...
  const handleNav = (key) => {
    switch (key) {
      ...
      case "dashboard":
        ...
        break;
      case "cari":
        navigate("/mahasiswa/cari-barang");
        break;
      case "tiket":
        navigate("/mahasiswa/tiket");
        break;
      case "lapor":
        navigate("/mahasiswa/lapor");
        break;
      case "notifikasi":
        navigate("/mahasiswa/notifikasi");
        break;
      case "detail_tiket":
        navigate("/mahasiswa/detail-tiket");
        break;
      case "detail_postingan":
        navigate("/mahasiswa/detail-postingan");
        break;

      case "admin_dashboard":
        navigate("/admin/dashboard");
        break;
      case "admin_tiket_hilang":
        navigate("/admin/tiket-hilang");
        break;
      case "admin_tiket_temuan":
        navigate("/admin/tiket-temuan");
        break;
      case "admin_verifikasi":
        navigate("/admin/verifikasi");
        break;
      case "admin_postingan":
        navigate("/admin/postingan");
        break;
      case "admin_buat_postingan":
        navigate("/admin/buat-postingan");
        break;
      case "admin_detail_tiket":
        navigate("/admin/detail-tiket");
        break;
